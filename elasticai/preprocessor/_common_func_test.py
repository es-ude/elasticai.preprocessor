...
class TestDigitalFunc(TestCase):
    ...
    def test_range_unsigned_2_0(self):
        range_val = self.method.define_limits(
            bit_signed=False, total_bitwidth=2, frac_bitwidth=0
        )
    ...
    def test_range_signed_2_0(self):
        range_val = self.method.define_limits(
            bit_signed=True, total_bitwidth=2, frac_bitwidth=0
        )
    ...
    def test_range_unsigned_6_2(self):
        range_val = self.method.define_limits(
            bit_signed=False, total_bitwidth=6, frac_bitwidth=2
        )
    ...
    def test_range_signed_6_2(self):
        range_val = self.method.define_limits(
            bit_signed=True, total_bitwidth=6, frac_bitwidth=2
        )
    ...
    def test_quantize_type_numpy(self):
        self.method.define_limits(bit_signed=False, total_bitwidth=2, frac_bitwidth=0)
        output = self.method._quantize_fxp(self.input_quant)
    ...
    def test_quantize_signed_4_2(self):
        ...
        ref = np.array(
            [-2.0, -2.0, -1.75, -1.25, -0.5, 0.0, 0.5, 1.25, 1.75, 1.75, 1.75]
        )
    ...
    def test_extract_rising_edge_double(self):
        stimulus = np.array(
            [False, False, True, True, False, False, True, True, False], dtype=bool
        )
        points = self.method._extract_rising_edge(stimulus)
