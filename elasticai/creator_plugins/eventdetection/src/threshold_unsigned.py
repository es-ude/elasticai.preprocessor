...
@type_handler_iterable()
def threshold_unsigned(impl: DataGraph, _: Registry) -> Iterable[Code]:
    package_path = "elasticai.creator_plugins.eventdetection"
    path2file = "verilog/detect_threshold_unsigned.v"
...
@type_handler_iterable()
def threshold_sub_unsigned(impl: DataGraph, _: Registry) -> Iterable[Code]:
    package_path = "elasticai.creator_plugins.eventdetection"
    path2file = "verilog/detect_threshold_sub_unsigned.v"
