...
def build_thresholding_mavg(
    ...
    assert bitwidth in range(2, 33), "bitwidth must between 2 and 32."
    ...
    params = {
        ...
        "template_name": "thresholding_mavg_template.h",
        "module_id": module_id,
        "device_id": module_id.upper(),
        "data_type": get_embedded_datatype(bitwidth, signed),
    }
    template_c = _generate_thresholding_mavg_template()
    generate_c_files(
        path2save=path2save,
        template_name=params["template_name"],
        file_name="thresholding_mavg",
        module_id=module_id,
