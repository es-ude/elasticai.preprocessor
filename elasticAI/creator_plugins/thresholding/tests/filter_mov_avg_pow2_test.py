...
#     src_files=["filter_mov_avg_pow2.v"],
#     top_module_name="MOVING_AVERAGE_POW2",
#     cocotb_test_module="elasticai.creator_plugins.filters.tests.filter_mov_avg_pow2_tb",
...
async def filter_fir_mavg_pow2_test(
    ...
    for idx in range(num_repeats):
        ...
        for val in data_in_array:
            ...
            # assert dut.DATA_OUT.value == calc_mavg(
            #     mavg_buffer, used_bitwidth, signed=do_signed
            # )
